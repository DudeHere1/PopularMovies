...
import com.example.pranavjayaraj.popularmovies.adapters.ReviewAdapter;
import com.example.pranavjayaraj.popularmovies.adapters.TrailerAdapter;
...
import com.example.pranavjayaraj.popularmovies.Models.Review;
import com.example.pranavjayaraj.popularmovies.Models.Trailer;
                            ...
                            // if it is not in favorites
                                ...
                                new AsyncTask<Void, Void, Uri>() {
                                    ...
                                    protected Uri doInBackground(Void... params) {
                                        ...
                                        values.put(MoviesContract.MoviesEntry.COLUMN_IMAGE, mMovie.getImage());
                                        values.put(MoviesContract.MoviesEntry.COLUMN_IMAGE2, mMovie.getImage2());
                                        ...
                                        values.put(MoviesContract.MoviesEntry.COLUMN_DATE, mMovie.getDate());
                                        values.put(MoviesContract.MoviesEntry.COLUMN_POP,mMovie.getPop());
                                        values.put(MoviesContract.MoviesEntry.COLUMN_COUNT,mMovie.getCount());

                                        return getActivity().getContentResolver().insert(MoviesContract.MoviesEntry.CONTENT_URI,
                                                values);
                                    }
